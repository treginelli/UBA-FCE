...
## Basado en una guía desarrollada por las Profs. GIRIMONTE Y MOLINARI
...
setwd("C:/Users/Rodri/Desktop/Estadística Actuarial/R/Clase 1")  ## acá coloquen la ruta donde poseen los archivos de trabajo
...
# La función "seq" produce secuencias equi-espaciadas, con paso que se puede determinar. Por default usa paso 1.

seq(1,5)

seq(1,5,0.5)

# Con la función rep replica un valor dado la cantidad de veces que se le indique: rep(valor, longitud)
...
## Operador de asignación “<-“: nos permite asignar un nombre/valor/formato a un objeto
...
A[7]    # devuelve el septimo elemento de la matriz recorriéndola por columnas.
...
colnames(Notas) <- c("Nombre","Primer parcial","Segundo Parcial","Tutoría")
Notas
...
Notas$Primer Parcial    ## Qué error posee esta línea de código ##
...
colnames(Notas2) <- c("Nombre","Primer parcial","Segundo Parcial","Género")
...
# las listas tienen asociada longitud y no dimensión. 
