...
Newton<-function(A,xs){
  ...
  print(imp)
  # dev.new()
  plot(B,vint,type = "l",xlab = "X",ylab = "Fx",col="black",lwd=2,main = "Polinomio Newton")
  points(A,pch = 19,cex=0.9,lwd=0.1,bg="red")
  points(xs,imp,pch = 1,cex=0.5,lwd=0.1,bg="yellow")
}
